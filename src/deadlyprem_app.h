 ...
 public:
  ...
  std::optional<rex::PathConfig> OnFinalizePaths(
    ...
    rex::ui::SetDebugOverlayBuildStamp(
        "Deadly Premonition Recompilation 1.2.1 (build " __DATE__ ") - ReXGlue 0.10 nightly - by «Little Bit»");
    if (window()) {
      window()->SetTitle("Deadly Premonition Recompilation | 1.2.1 «Little Bit»");
    }
