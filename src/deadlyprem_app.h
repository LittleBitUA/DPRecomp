 ...
 public:
  ...
  std::optional<rex::PathConfig> OnFinalizePaths(
    ...
    rex::ui::SetDebugOverlayBuildStamp(
        "Deadly Premonition Recompilation 1.4.7 (build " __DATE__ ") - ReXGlue 0.10 nightly - by «Little Bit»");
    if (window()) {
      window()->SetTitle("Deadly Premonition Recompilation 1.4.7 | «Little Bit»");
    }
  ...
  void OnPostInitLogging() override {
    ...
    REXLOG_INFO("Deadly Premonition Recompilation 1.4.7 (build " __DATE__ ") - ReXGlue 0.10 nightly - by «Little Bit»");
  }
