/**
 * @file        deadlyprem_iso_installer.h
 *
 * @brief       First-run game data installer: extracts the XDVDFS (GDF) game
 *              partition of a user-supplied Deadly Premonition Xbox 360
 ...
 *              Title Update 1 wizard in the Downpour Title Update wizard (not needed for DP1).
 */
#pragma once
