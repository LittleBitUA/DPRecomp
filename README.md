...
[![Latest release](https://img.shields.io/github/v/release/LittleBitUA/DPRecomp?style=for-the-badge&label=Download&color=blue)](https://github.com/LittleBitUA/DPRecomp/releases/download/v2.0.1/DPRecomp-2.0.1-win64.zip)
...
[![Platform](https://img.shields.io/badge/platform-Windows%2010%2F11-0078D6?style=for-the-badge&logo=windows)](https://github.com/LittleBitUA/DPRecomp/releases/download/v2.0.1/DPRecomp-2.0.1-win64.zip)
...
## [⬇ &nbsp;Download 2.0.1 for Windows](https://github.com/LittleBitUA/DPRecomp/releases/download/v2.0.1/DPRecomp-2.0.1-win64.zip)

`DPRecomp-2.0.1-win64.zip` · 42 MB · Windows 10 / 11 64-bit

[Release notes](docs/RELEASE-NOTES-2.0.1.md) · [Steam artwork pack](https://github.com/LittleBitUA/DPRecomp/releases/download/v1.3.0/DPRecomp-Steam-artwork.zip) · [Report a bug](https://github.com/LittleBitUA/DPRecomp/issues/new) · [Changelog](docs/CHANGELOG.md)
...
1. **Download** [`DPRecomp-2.0.1-win64.zip`](https://github.com/LittleBitUA/DPRecomp/releases/download/v2.0.1/DPRecomp-2.0.1-win64.zip) and unzip it anywhere outside *Program Files*.
...
**2.0.1:** safety fixes for the native renderer found in a review right after 2.0: an experimental texture-sharing path that could leave a stale image after a level change is now off, a possible crash and some wasted CPU time in the render-target handling are gone. Nothing you saw in 2.0 looks different. [Notes](docs/RELEASE-NOTES-2.0.1.md).
