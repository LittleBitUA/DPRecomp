...
>
> **Next update (in testing now): keyboard key prompts.** The game's A / B / X / Y / LB / RB / LT / RT icons are replaced by pictures of *your* keys, generated by the launcher from your key bindings — see [Keyboard prompts and texture modding](#keyboard-prompts-and-texture-modding). The same mechanism lets anyone swap any texture in the game with a PNG.
>
